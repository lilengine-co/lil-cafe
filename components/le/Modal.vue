            ...
            <div class="sm:flex sm:items-start">
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h2 class="text-3xl font-bold leading-6 font-medium text-white mb-3" id="modal-title">
                    WE ARE CLOSED ON 3RD SEPTEMBER!
                </h2>
                <div class="mt-2">
                  <p class="text-white text-lg mb-1">
                    We want to inform you that on September 3rd, we will be temporarily closed for the day due to essential electricity work that has been planned by the local government on Tennant Street during our business hours!
                  </p>
                  <p class="text-white text-lg">
                    We apologise for any inconvenience this may cause and appreciate your understanding. We look forward to welcoming you back on 4th September.
                   </p>
