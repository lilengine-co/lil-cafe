            ...
            <div class="sm:flex sm:items-start">
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h2 class="text-3xl font-bold leading-6 font-medium text-white mb-3" id="modal-title">
                    WE ARE OPEN FOR RECONCILIATION DAY!
                </h2>
                <div class="mt-2">
                  ...
                  <p class="text-white text-lg">
                    We are open for takeaway and dine-in service for next Monday 29th of May for Reconciliation Day from <span data-v-6831b08e="" class="font-bold"> 8:00am-2:00pm</span>.
                   </p>
