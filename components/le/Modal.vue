            ...
            <div class="sm:flex sm:items-start">
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h2 class="text-3xl font-bold leading-6 font-medium text-white mb-3" id="modal-title">
                    WE ARE CLOSED ON EASTER HOLIDAYS!
                </h2>
                <div class="mt-2">
                  ...
                  <p class="text-white text-lg">
                    Plumb Cafe & Eatery will be closed on Easter Holidays for the 29th of March and the 1st of April. However, we'll still be open and ready to serve you on the 30th and 31st of March. Wishing you a joy-filled Easter season!
                   </p>
